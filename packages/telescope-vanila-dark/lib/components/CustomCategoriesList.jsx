...
import { Button, DropdownButton, MenuItem, Modal, Glyphicon } from 'react-bootstrap';
...
class CustomCategoriesList extends Component {
...
module.exports = withRouter(CustomCategoriesList);
export default withRouter(CustomCategoriesList);
