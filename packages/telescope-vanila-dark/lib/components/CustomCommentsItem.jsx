...
class CustomCommentsItem extends Component{
  ...
  renderComment() {
    ...
    return (
      <div className="comments-item-text">
        ...
        {!this.props.comment.isDeleted ? <a className="comments-item-reply-link" onClick={this.showReply}><FormattedMessage id="comments.reply"/></a> : null}
