import { ModalTrigger, Components, registerComponent, withList, Utils, replaceComponent, getRawComponent } from "meteor/vulcan:core";
    ...
    return (
      <div>
        <DropdownButton
          ...
          title={<Components.Icon name="align-justify"/>}
